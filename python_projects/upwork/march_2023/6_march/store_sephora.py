...
https://www.youtube.com/watch?v=Y8k1RlLzntU
import pandas as pd
...
class drugs:
    ...
    def cost_n_drugs(self):
        ...
        driver.get("https://www.sephora.co.uk/offers")
        time.sleep(3)
        
        # Product patih
        product_xpath= driver.find_element(By.XPATH, "//div[@id='fullcolumn']//div[contains(@class, 'eba-product-listing')]/div[position()>1]")
