...
# Question: Get  text from images.
# Description: This text will not be copied and pasted
# path: C:\Users\HIMADRI TANAYA\AppData\Local\Programs\Tesseract-OCR
...
image = cv2.imread(r"test_images/2.jpg")
